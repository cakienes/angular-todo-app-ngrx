...
describe('Redux: TodoSelectors', () => {
  ...
  describe('Test for getVisibleTodos', () => {
    it('should return the all todos with fitler FilterOptions.SHOW_ALL', () => {
      const state = {
        todos: [
    ...
    it('should return the completed todos with fitler FilterOptions.SHOW_COMPLETED', () => {
      const state = {
        todos: [
          { id: 1, text: 'todo', completed: false },
          { id: 2, text: 'todo', completed: true },
        ...
        filter: FilterOptions.SHOW_COMPLETED,
      };
      const todos = TodoSelectors.getVisibleTodos(state);
      expect(todos.length).toEqual(1);
    });

    it('should return the undone todos with fitler FilterOptions.SHOW_ACTIVE', () => {
      const state = {
        todos: [
          { id: 1, text: 'todo', completed: false },
          { id: 2, text: 'todo', completed: true },
        ...
        filter: FilterOptions.SHOW_ACTIVE,
      };
      const todos = TodoSelectors.getVisibleTodos(state);
